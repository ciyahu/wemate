...
<!-- 设置图片宽度为 300px -->
<img src="https://github.com/user-attachments/assets/4afbd6dd-c49f-4ba1-b06d-b8e2fafbcd0f?raw=true" alt="微信图片_20250809110339" width="300" /> <!-- 修改：替换为 HTML img 标签，添加 width 属性 -->
